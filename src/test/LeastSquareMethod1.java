...
public class LeastSquareMethod1 {  
     ...
     */  
    public LeastSquareMethod1(double[] x, double[] y, int n) {  
     ...
     *            The order of polynomial 
     */  
    public LeastSquareMethod1(double[] x, double[] y, double[] weight, int n) {  
    ...
    public static void main(String[] args) {  
        LeastSquareMethod1 eastSquareMethod = new LeastSquareMethod1(  
        ...
        LeastSquareMethod1 eastSquareMethod2 = new LeastSquareMethod1(  
                new double[] { 0.5, 1.0, 1.5, 2.0, 2.5, 3.0 }, new double[] {  
